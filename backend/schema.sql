...
-- 28. Tabelas do Módulo de Torneios e Placar em Tempo Real
...
CREATE TABLE IF NOT EXISTS tournament_registrations (
    ...
    dojo_id TEXT REFERENCES profiles(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS tournament_matches (
    ...
    athlete_red_id TEXT REFERENCES profiles(id) ON DELETE SET NULL,
    athlete_red_name VARCHAR(255),
    athlete_blue_id TEXT REFERENCES profiles(id) ON DELETE SET NULL,
